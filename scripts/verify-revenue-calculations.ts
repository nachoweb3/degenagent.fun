 ...
 *
 * Uso: npx ts-node scripts/verify-revenue-calculations.ts
 */

import { LAMPORTS_PER_SOL } from '@solana/web3.js';

function calculateRevenueShare(amountInSOL: number, actualOutputSOL: number) {
...
function calculateUserShare(revenuePoolSOL: number, userTokens: number, totalSupply: number) {
...
export { calculateRevenueShare, calculateUserShare };
